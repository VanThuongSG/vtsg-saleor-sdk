...
export interface OrdersByUser_me_orders_edges_node_lines_variant_room {
    __typename: "Room";
    name: string;
    /**
...
export interface OrdersByUser_me_orders_edges_node_lines_variant {
     ...
     */
    id: string;
    room: OrdersByUser_me_orders_edges_node_lines_variant_room;
}
...
export interface OrdersByUser_me_orders_edges_node_lines {
    ...
    /**
     * The main thumbnail for the ordered room.
     */
