...
export interface CheckoutDetails_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface CheckoutDetails_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CheckoutDetails_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface CheckoutDetails_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: CheckoutDetails_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: CheckoutDetails_checkout_lines_variant_room_thumbnail2x | null;
    roomType: CheckoutDetails_checkout_lines_variant_room_roomType;
}
export interface CheckoutDetails_checkout_lines_variant {
    ...
    room: CheckoutDetails_checkout_lines_variant_room;
}
