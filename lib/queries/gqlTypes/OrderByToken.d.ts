...
export interface OrderByToken_orderByToken_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface OrderByToken_orderByToken_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface OrderByToken_orderByToken_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface OrderByToken_orderByToken_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: OrderByToken_orderByToken_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: OrderByToken_orderByToken_lines_variant_room_thumbnail2x | null;
    roomType: OrderByToken_orderByToken_lines_variant_room_roomType;
}
export interface OrderByToken_orderByToken_lines_variant {
    ...
    room: OrderByToken_orderByToken_lines_variant_room;
}
