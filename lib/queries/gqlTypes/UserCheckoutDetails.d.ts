...
export interface UserCheckoutDetails_me_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface UserCheckoutDetails_me_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: UserCheckoutDetails_me_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: UserCheckoutDetails_me_checkout_lines_variant_room_thumbnail2x | null;
    roomType: UserCheckoutDetails_me_checkout_lines_variant_room_roomType;
}
export interface UserCheckoutDetails_me_checkout_lines_variant {
    ...
    room: UserCheckoutDetails_me_checkout_lines_variant_room;
}
