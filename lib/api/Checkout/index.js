...
class SaleorCheckoutAPI extends helpers_1.ErrorListener {
    constructor(saleorState, jobsManager) {
        ...
        this.setBillingAddress = (billingAddress, email) => __awaiter(this, void 0, void 0, function* () {
            ...
            const isShippingRequiredForRooms = (_f = (_e = this.saleorState.checkout) === null || _e === void 0 ? void 0 : _e.lines) === null || _f === void 0 ? void 0 : _f.filter(line => line.quantity > 0).some(({ variant }) => { var _a; return (_a = variant.room) === null || _a === void 0 ? void 0 : _a.roomType.isShippingRequired; });
            const alteredLines = (_h = (_g = this.saleorState.checkout) === null || _g === void 0 ? void 0 : _g.lines) === null || _h === void 0 ? void 0 : _h.map(item => ({
                quantity: item.quantity,
                variantId: item === null || item === void 0 ? void 0 : item.variant.id,
            }));
            if (isShippingRequiredForRooms &&
            ...
            if (!isShippingRequiredForRooms && email && checkoutId && alteredLines) {
            ...
            if (!isShippingRequiredForRooms && email && alteredLines) {
                const { data, dataError } = yield this.jobsManager.run("checkout", "createCheckout", {
                    billingAddress,
                    email,
                    lines: alteredLines,
            ...
            if (!isShippingRequiredForRooms && !email) {
                return {
                    functionError: {
                        error: new Error("You need to provide email when rooms do not require shipping before setting billing address."),
        ...
        this.createPayment = (gateway, token, creditCard) => __awaiter(this, void 0, void 0, function* () {
            var _r, _s, _t, _u;
            ...
            if (checkoutId &&
                ...
                amount !== null &&
                amount !== undefined) {
                const { data, dataError } = yield this.jobsManager.run("checkout", "createPayment", {
                    amount,
                    billingAddress,
                    checkoutId,
                    creditCard,
        ...
        this.completeCheckout = () => __awaiter(this, void 0, void 0, function* () {
            var _v;
            const checkoutId = (_v = this.saleorState.checkout) === null || _v === void 0 ? void 0 : _v.id;
            if (checkoutId) {
                const { data, dataError } = yield this.jobsManager.run("checkout", "completeCheckout", { checkoutId });
                return {
                    data,
                    dataError,
                    pending: false,
        ...
        this.saleorState.subscribeToChange(types_1.StateItems.CHECKOUT, (checkout) => {
            const { id, token, email, shippingAddress, billingAddress, selectedShippingAddressId, selectedBillingAddressId, billingAsShipping, availableShippingMethods, shippingMethod, promoCodeDiscount, } = checkout || {};
            this.checkout = {
                billingAddress,
                email,
                id,
        ...
        this.saleorState.subscribeToChange(types_1.StateItems.PAYMENT_GATEWAYS, (paymentGateways) => {
