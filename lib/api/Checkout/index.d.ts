...
import { DataErrorCheckoutTypes, FunctionErrorCheckoutTypes, IAddress, IAvailableShippingMethods, ICheckout, IPayment, IPromoCodeDiscount } from "./types";
export declare class SaleorCheckoutAPI extends ErrorListener {
    ...
    createPayment: (gateway: string, token: string, creditCard?: import("../../helpers").IPaymentCreditCard | undefined) => PromiseRunResponse<DataErrorCheckoutTypes, FunctionErrorCheckoutTypes>;
    completeCheckout: () => PromiseRunResponse<DataErrorCheckoutTypes, FunctionErrorCheckoutTypes>;
}
