...
export interface Checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface Checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface Checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface Checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: Checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: Checkout_lines_variant_room_thumbnail2x | null;
    roomType: Checkout_lines_variant_room_roomType;
}
