...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: CreateCheckout_checkoutCreate_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: CreateCheckout_checkoutCreate_checkout_lines_variant_room_thumbnail2x | null;
    roomType: CreateCheckout_checkoutCreate_checkout_lines_variant_room_roomType;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant {
    ...
    room: CreateCheckout_checkoutCreate_checkout_lines_variant_room;
}
