...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_thumbnail2x | null;
    roomType: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room_roomType;
}
export interface RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant {
    ...
    room: RemoveCheckoutPromoCode_checkoutRemovePromoCode_checkout_lines_variant_room;
}
