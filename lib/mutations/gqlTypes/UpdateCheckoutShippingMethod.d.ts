...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_thumbnail2x | null;
    roomType: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room_roomType;
}
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant {
    ...
    room: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_lines_variant_room;
}
