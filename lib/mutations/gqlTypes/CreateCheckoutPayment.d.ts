...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_thumbnail2x | null;
    roomType: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room_roomType;
}
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant {
    ...
    room: CreateCheckoutPayment_checkoutPaymentCreate_checkout_lines_variant_room;
}
