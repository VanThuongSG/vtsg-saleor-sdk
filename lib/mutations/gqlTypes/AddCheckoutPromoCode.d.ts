...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_thumbnail2x | null;
    roomType: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room_roomType;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant {
    ...
    room: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_room;
}
