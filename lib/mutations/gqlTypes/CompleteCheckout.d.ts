...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_room_thumbnail {
    __typename: "Image";
    /**
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_room_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_room_roomType {
    __typename: "RoomType";
    isShippingRequired: boolean;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_room {
    __typename: "Room";
    /**
     * The ID of the object.
     */
     ...
     */
    thumbnail: CompleteCheckout_checkoutComplete_order_lines_variant_room_thumbnail | null;
    /**
     * The main thumbnail for a room.
     */
    thumbnail2x: CompleteCheckout_checkoutComplete_order_lines_variant_room_thumbnail2x | null;
    roomType: CompleteCheckout_checkoutComplete_order_lines_variant_room_roomType;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant {
    ...
    room: CompleteCheckout_checkoutComplete_order_lines_variant_room;
}
