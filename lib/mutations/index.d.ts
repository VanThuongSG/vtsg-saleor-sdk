...
export declare const MUTATIONS: {
    ...
    TokenAuth: <TCacheShape_6>(client: ApolloClient<TCacheShape_6>, options: MutationOptions<TokenAuth, TokenAuthVariables>) => Promise<import("apollo-link").FetchResult<TokenAuth, Record<string, any>, Record<string, any>>>;
    UpdateUserAddress: <TCacheShape_7>(client: ApolloClient<TCacheShape_7>, options: MutationOptions<UpdateUserAddress, UpdateUserAddressVariables>) => Promise<import("apollo-link").FetchResult<UpdateUserAddress, Record<string, any>, Record<string, any>>>;
};
