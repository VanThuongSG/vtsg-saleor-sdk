...
export declare const mutationFactory: <T extends "signIn" | "getAttributes" | "getRoomDetails" | "getRoomList" | "getCategoryDetails" | "getOrdersByUser" | "getOrderDetails" | "getVariantsRooms" | "getShopDetails" | "setUserDefaultAddress" | "setDeleteUserAddress" | "setCreateUserAddress" | "setUpdateuserAddress" | "setAccountUpdate" | "client" | "setPassword" | "setPasswordChange" | "attachAuthListener" | "isLoggedIn" | "watchQuery" | "fireQuery", TVariables extends Variables<T>, TOptions extends Options<T>>(mutation: T) => (variables?: TVariables | undefined, options?: TOptions | undefined) => [MutationFn<ReturnData<T>, TVariables>, MutationResult<ReturnData<T>>];
export {};
